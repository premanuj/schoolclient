...
<div id="page-content">
    <div class="container">
        <header><h1>My Exams</h1></header>
        <div class="row">
            <div class="col-md-12">
                <section id="my-account">
                    <ul class="nav nav-tabs" id="tabs">
                        <li class="active"><a href="exams.php#tab-my-exam" data-toggle="tab" class="view-exam"><?php echo $_GET['sub']; ?></a></li>
                    </ul><!-- /#my-profile-tabs -->
                    <section class = "answer-submited">
                        <div>
                            <p>Answer submitted Successfully</p>
                            <button class="btn btn-sm btn-primary btn-flat pull-left back-exam-title">Back</button>
                         </div>
                    </section>
                    <div class="tab-content my-account-tab-content">
                        <div class="tab-pane active" id="tab-my-exam">
